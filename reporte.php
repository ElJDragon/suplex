...
while ($row=$rs->fetch_assoc()) {
    $pdf->Cell(35,10,$row['estCedula'],1);
    $pdf->Cell(35,10,$row['estNombre'],1);
    $pdf->Cell(35,10,$row['estApellido'],1);
    $pdf->Cell(35,10,$row['estTelefono'],1);
    $pdf->Cell(50,10,$row['estDireccion'],1);
    $pdf->Ln();
}
